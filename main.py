...
const hobbies = [
  ...
  "드로잉 클래스", "모형 조립", "비누 만들기", "아로마 테라피", "악기 연주",
  "보컬 트레이닝", "마술 배우기", "크로키 그리기", "하이킹", "바둑 두기",
  "종이접기", "게임 만들기", "영상 편집", "라탄 공예", "그림책 만들기",
  "수제 초콜릿", "천연 화장품 만들기", "타로 배우기", "디지털 아트",
  "인테리어 꾸미기", "곤충 키우기", "도서관 탐방", "마크 서버 운영", "자수 놓기",
  "펜팔 하기", "블로그 쓰기"
];
